    ...
    <div class="flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
      <div class="p-4 md:p-5">
        ...
        <div class="mt-1 flex items-center gap-x-2">
          ...
          {isPositive ? <span class="inline-flex items-center gap-x-1 py-0.5 px-2 rounded-full bg-green-100 text-green-900 dark:bg-green-800 dark:text-green-100">
            ...
            </span>: <span class="inline-flex items-center gap-x-1 py-0.5 px-2 rounded-full bg-red-100 text-red-900 dark:bg-red-800 dark:text-red-100">
...
const Stats = () => {
    ...
    const [statsData, setStatsData] = useState({ purchases: 0, revenue: 0, refunds: 0 });
    ...
    <StatsCard title="Purchases" value={statsData?.purchases} change="+32%" isPositive={true} />
    <StatsCard title="Revenue" value={statsData.revenue} change="+49%" isPositive={true} />
    <StatsCard title="Refunds" value={statsData.refunds} change="-7%" isPositive={false} />
  </div>
}
